...
{
    /** @var \MageSuite\OrderExport\Services\Export\Exporter\Strategy\CSV\Separated */
    ...
    protected function setUp()
    {
        ...
        $this->csvExporter = Bootstrap::getObjectManager()->create(
            'MageSuite\OrderExport\Services\Export\Exporter\Strategy\CSV\Separated',
    ...
    public function testOrderCollectionConverter()
    {
        ...
        foreach ($data as $key => $order) {
            if($key == 0) {
                ...
                $expectedDir = __DIR__ . '/../../../../assets/expected_export_separated.csv';
                $expected = ['success' => 1, 'successIds' => ['100000001'], 'ordersData'];
            } else {
                $exportDir = __DIR__ . '/../../../../assets/export2.csv';
                $expectedDir = __DIR__ . '/../../../../assets/expected_export_separated2.csv';
                $expected = ['success' => 1, 'successIds' => ['100000002'], 'ordersData'];
            }
            $result = $this->csvExporter->export($order, $exportDir);
    ...
    public function tearDown()
    {
        ...
        if (file_exists(__DIR__ . '/../../../../assets/export2.csv')) {
            unlink(__DIR__ . '/../../../../assets/export2.csv');
        }
    }
}