...
namespace MageSuite\OrderExport\Test\Integration\Services\FTP;
...
class UploaderTest extends TestCase
{
    ...
    /**
     * @var \MageSuite\OrderExport\Services\FTP\Uploader
     */
    private $uploader;
    ...
    public function setUp()
    {
        ...
        $this->uploader = $this
            ->objectManager
            ->create(
                \MageSuite\OrderExport\Services\FTP\Uploader::class,
